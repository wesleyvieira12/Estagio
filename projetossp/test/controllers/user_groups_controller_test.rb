...
class UserGroupsControllerTest < ActionController::TestCase
  ...
  test "should create user_group" do
    assert_difference('UserGroup.count') do
      post :create, user_group: { description: @user_group.description, level: @user_group.level, name: @user_group.name }
    end
  ...
  test "should update user_group" do
    patch :update, id: @user_group, user_group: { description: @user_group.description, level: @user_group.level, name: @user_group.name }
    assert_redirected_to user_group_path(assigns(:user_group))
  end
